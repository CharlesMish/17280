...
const outDir = process.argv[2] || "/tmp/watch-baseline";
...
await page.goto("http://127.0.0.1:5173/?static=1&view=threeQuarter&t=0", {
  waitUntil: "load",
});
await page.waitForFunction(() => window.__WATCH__ !== undefined);
await page.waitForTimeout(900);

for (const spec of shots.length ? shots : defaultShots) {
